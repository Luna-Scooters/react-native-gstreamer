...
Pod::Spec.new do |s|
  ...
  # Use explicit path instead of ${HOME}
  home_dir = ENV['HOME'] || '~'
  gstreamer_framework_path = "#{home_dir}/Library/Developer/GStreamer/iPhone.sdk"
  
  s.pod_target_xcconfig = {
    'DEFINES_MODULE' => 'YES',
    #'FRAMEWORK_SEARCH_PATHS' => "\"#{gstreamer_framework_path}\"",
  ...
  # Define a vendored_framework instead of manually configuring it
